...
func main() {
	...
	mux.HandleFunc("/api/quizzes/{id}/submissions/{submissionId}/certificate", withCORS(cfg.FrontendOrigin, auth.RequireAuth(cfg.JWTSecret, handlers.QuizSubmissionCertificateHandler(conn))))
